...
class SAPFCDFilterTestCase(BackendFiltersTestCase):
    ...
    def test_backend_passes_not_migrating(self):
        host = fakes.FakeBackendState('host1@backend1#pool1',
                                      {'capabilities': {},
                                       'vendor_name': VMWARE_VENDOR,
                                       'storage_protocol': 'vstorageobject'})
    ...
    def test_backend_passes_migrating_to_same_backend_no_pool(self):
        """This should pass because the pool is the same as the original pool."""
        host = fakes.FakeBackendState('host1@backend1#pool1',
                                      {'capabilities': {},
                                       'vendor_name': VMWARE_VENDOR,
                                       'storage_protocol': 'vstorageobject'})
    ...
    def test_backend_passes_migrating_to_same_backend_different_pool_no_pool(self):
    ...
    def test_backend_passes_migrating_to_different_backend_no_pool(self):
        """This should pass because the pool is the same as the original pool."""
    ...
    def test_backend_fails_migrating_to_different_backend_no_pool(self):
        """This should fail because the pool is different from the original pool."""
        host = fakes.FakeBackendState('host1@backend2#pool2',
                                      {'capabilities': {},
                                       'vendor_name': VMWARE_VENDOR,
                                       'storage_protocol': 'vstorageobject'})
        props = self.props.copy()
    ...
    def test_backend_passes_migrating_to_same_backend_different_pool(self):
        host = fakes.FakeBackendState('host1@backend1#pool1',
                                      {'capabilities': {},
                                       'vendor_name': VMWARE_VENDOR,
                                       'storage_protocol': 'vstorageobject'})
    ...
    def test_backend_passes_migrating_to_different_backend_same_pool(self):
        host = fakes.FakeBackendState('host1@backend2#pool1',
                                      {'capabilities': {},
                                       'vendor_name': VMWARE_VENDOR,
                                       'storage_protocol': 'vstorageobject'})
    ...
    def test_backend_fails_migrating_to_different_backend_different_pool(self):
