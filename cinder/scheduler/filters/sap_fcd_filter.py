...
class SAPFCDFilter(filters.BaseBackendFilter):
    ...
    def backend_passes(self, backend_state, filter_properties):
        ...
        if destination_host:
            ...
            # For a find_backend_for_connector operation, the destination host
            # is the host that the connector is being migrated to as there is no
            # destination_host specified in the request spec.
